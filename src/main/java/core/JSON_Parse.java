...
public class JSON_Parse {
	...
	public static void main(String[] args) throws IOException {
		...
		String item_02_name = "Withings Pulse";
		Double item_02_usd_price = 99.95;
	
		String item_03_name = "Galaxy Tab 4";
		Double item_03_usd_price = 147.95;
		
		String item_04_name = "HERO3+ camera";
		Double item_04_usd_price = 357.00;
		
		String item_05_name = "Apple iPhone 5s";
		Double item_05_usd_price = 429.99;
		...
		Double item_01_eur_price = 0.0; //  123.74
		Double item_01_cny_price = 0.0; //  892.69
		Double item_01_gbp_price = 0.0; //   91.01
		Double item_01_uah_price = 0.0; // 2988.92
		Double item_01_rub_price = 0.0; // 8678.7
		
		Double item_02_eur_price = 0.0; //   88.04
		Double item_02_cny_price = 0.0; //  635.09
		Double item_02_gbp_price = 0.0; //   64.75
		Double item_02_uah_price = 0.0; // 2126.44
		Double item_02_rub_price = 0.0; // 6174.36
		
		Double item_03_eur_price = 0.0; //  130.31
		Double item_03_cny_price = 0.0; //  940.09
		Double item_03_gbp_price = 0.0; //   95.84
		Double item_03_uah_price = 0.0; // 3147.64
		Double item_03_rub_price = 0.0; // 9139.54
		
		Double item_04_eur_price = 0.0; //   314.55
		Double item_04_cny_price = 0.0; //  2267.2
		Double item_04_gbp_price = 0.0; //   231.23
		Double item_04_uah_price = 0.0; //  7595.17
		Double item_04_rub_price = 0.0; // 22053.5
		
		Double item_05_eur_price = 0.0; //   378.86
		Double item_05_cny_price = 0.0; //  2732.2
		Double item_05_gbp_price = 0.0; //   278.55
		Double item_05_uah_price = 0.0; //  9148.04
		Double item_05_rub_price = 0.0; // 26562.42
